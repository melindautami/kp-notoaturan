...
<button class="accordion">PT vs CV, manakah yang lebih aman?</button>
<div class="panel">
  <p>Perseroan Terbatas (PT) memiliki kelebihan di mana harta kekayaan pribadi pemegang saham dipisahkan dari harta perusahaan, sehingga dalam hal terjadi kerugian atau kebangkrutan hanya akan melibatkan harta sebatas yang disetorkan dalam bentuk kepemilikan saham. Berbeda halnya dengan CV, yang dapat meminta pertanggungjawaban hingga harta pribadi pemilik bila perusahaan mengalami kerugian. Anda dapat mengkonsultasikan lebih lanjut terkait hal ini dengan lawyer kami di halo@ultranesia.com </p>
</div>

<button class="accordion">Bisakah mendirikan PT tanpa memiliki domisili tetap?</button>
<div class="panel">
  <p>Melalui layanan virtual office di Notoaturan, Anda dapat dengan mudah mendirikan PT tanpa memiliki domisili tetap.</p>
</div>

<button class="accordion">Bolehkah nama PT mengandung unsur bahasa asing? </button>
<div class="panel">
  <p>Tidak, kewajiban ini tertuang dalam Peraturan Pemerintah (PP) No.43 Tahun 2011, yang mengatakan bahwa perseroan yang seluruh sahamnya dimiliki oleh warga negara Indonesia atau badan hukum Indonesia wajib memakai nama perseroan dalam bahasa Indonesia. Sehingga apabila tetap menggunakan nama asing, konsekuensinya nama tersebut bisa ditolak menteri.</p>
</div>

<button class="accordion">Apa saja jenis Badan Usaha?</button>
<div class="panel">
  <p>
